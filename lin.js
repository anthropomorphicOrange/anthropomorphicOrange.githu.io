 ...
 /*   timezone.innerHTML = 'America/Cocoa Beach';
    ...
    data.daily.forEach((day, idx) => {
      ...
      if(idx < 7){
        ...
        <div class="lg:space-x-24  md:flex-row lg:flex-row flex-col items-center justify-center  mt-20 border-2 box border-slate-500 px-5 py-1 bg-pink-100/[.8] text-center text-stone-700 rounded-2xl" id="current-temp">
