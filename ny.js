...
function getWeatherData () {
    ...
    navigator.geolocation.getCurrentPosition((success) => {
          ...
          fetch(`https://api.openweathermap.org/data/3.0/onecall?lat=${41}&lon=${-74}&exclude=hourly,minutely&units=imperial&appid=${API_KEY}`)
 ...
 /*   timezone.innerHTML = 'America/Cocoa Beach';
    ...
    data.daily.forEach((day, idx) => {
      ...
      if(idx < 7){
        ...
        <div class="lg:space-x-24 space-y-12 md:flex-row lg:flex-row flex-col items-center justify-center ml-10 mr-10 mt-5 border-2 box border-slate-500 px-5 py-1 bg-pink-100/[.8] text-center text-stone-700 rounded-2xl" id="current-temp">
